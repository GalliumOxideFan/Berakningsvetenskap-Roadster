...
route4 = route_nyc.nyc_route_traveler_euler(4, 1e-2)
route9 = route_nyc.nyc_route_traveler_euler(9.5, 1e-2)

plt.plot(route4[0], route4[1], label= 'Start 4:00', linewidth=5)
plt.plot(route9[0], route9[1], label="Start 9:30", color='magenta', linewidth=5)
plt.legend()
plt.show()
